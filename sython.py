...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@IIlIIIw"))
...
async def _(event):
      await event.reply("""السـورس يعمـل | 𝗕𝗟𝗔𝗖𝗞
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
قناة السورس : https://t.me/IIlIIIw
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""SY OWNER : @Q_3_I"""
)
